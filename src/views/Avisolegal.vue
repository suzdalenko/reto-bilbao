            ...
            <div class="row">
                <div class="col-xl-10 offset-xl-1">
                    ...
                    <p>Razón social: MUDANZAS RETO<br>
                       Email: mudanzas@retobilbao.com<br>
                    ...
                    <p>No tratamos  y no recopilamos datos.</p>
                    <b>USUARIOS</b>
                    <p>El acceso y/o uso de este portal de retobilbao.com atribuye la condición de USUARIO, 
                        que acepta, 
                    ...
                    <b>USO DEL PORTAL</b>
                    <p>retobilbao.com proporciona el acceso a multitud de informaciones, servicios, programas o datos (en adelante, "los contenidos") en Internet pertenecientes a retobilbao.com o a sus licenciantes a los que el USUARIO pueda tener acceso.
                        El USUARIO asume la responsabilidad del uso del portal. 
                        El USUARIO se compromete a hacer un uso adecuado de los contenidos y servicios que retobilbao.com puede ofrece a través de su portal y con carácter enunciativo pero no limitativo,
                        ...
                        de apología del terrorismo o atentatorio contra los derechos humanos; (iii) provocar daños en los sistemas físicos y lógicos de retobilbao.com, de sus proveedores o de terceras personas,
                        ...
                        retobilbao.com se reserva el derecho de retirar todos aquellos comentarios y aportaciones que vulneren el respeto a la dignidad de la persona, que sean discriminatorios, xenófobos, racistas, pornográficos, que atenten contra la juventud
                        o la infancia, el orden o la seguridad pública o que, a su juicio, no resultaran adecuados para su publicación. 
                        En cualquier caso, retobilbao.com no será responsable de las opiniones vertidas por los usuarios a través de los foros, chats, u otras herramientas de participación. </p>
                    <b>PROPIEDAD INTELECTUAL E INDUSTRIAL</b>
                    <p>retobilbao.com por sí o como cesionaria, es titular de todos los derechos de propiedad intelectual e industrial de su página web junto con las imagenes que son propiedad de Google  presentadas en el portal web,
                        ...
                        programas de ordenador necesarios para su funcionamiento, acceso y uso, etc.), titularidad de retobilbao.com o bien de Google y sus licenciantes. 
                        ...
                        sin la autorización de retobilbao.com. El USUARIO se compromete a respetar los derechos de Propiedad Intelectual e Industrial titularidad de retobilbao.com y Google.
                        ...
                        El USUARIO deberá abstenerse de suprimir, alterar, eludir o manipular cualquier dispositivo de protección o sistema de seguridad que estuviera instalado en el las páginas de retobilbao.com.</p>
                    <b>DIRECCIONES IP</b>
                    <p>No detectamos en ningun momento direccion IP de USUARIO.</p>
                    <b>EXCLUSIÓN DE GARANTÍAS Y RESPONSABILIDAD</b>
                    <p>retobilbao.com no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier naturaleza que pudieran ocasionar, a título enunciativo: errores u omisiones en los contenidos, falta de disponibilidad del portal o la transmisión 
                    ...
                    <b>MODIFICACIONES</b>
                    <p>retobilbao.com se reserva el derecho de efectuar sin previo aviso las modificaciones que considere oportunas en su portal, pudiendo cambiar, suprimir o añadir tanto los contenidos y servicios que se presten a través de la misma como 
                        la forma en la que éstos aparezcan presentados o localizados en su portal. </p>
                    <b>ENLACES</b>
                    <p>En el caso de que en retobilbao.com se dispusiesen enlaces o hipervínculos hacía otros sitios de Internet, retobilbao.com no ejercerá ningún tipo de control sobre dichos sitios y contenidos. En ningún caso retobilbao.com asumirá
                    ...
                    <p>retobilbao.com se reserva el derecho a denegar o retirar el acceso a portal y/o los servicios ofrecidos sin necesidad de preaviso, a instancia propia o de un tercero, a aquellos usuarios que incumplan las presentes Condiciones Generales de Uso. </p>
                    <b>GENERALIDADES</b>
                    <p>retobilbao.com perseguirá el incumplimiento de las presentes condiciones así como cualquier utilización indebida de su portal ejerciendo todas las acciones civiles y penales que le puedan corresponder en derecho. </p>
                    <b>MODIFICACIÓN DE LAS PRESENTES CONDICIONES Y DURACIÓN</b>
                    <p>retobilbao.com podrá modificar en cualquier momento las condiciones aquí determinadas, siendo debidamente publicadas como aquí aparecen. La vigencia de las citadas condiciones irá en función de su exposición y estarán vigentes hasta que sean modificadas por otras debidamente publicadas. </p>
                    <b>SEGURIDAD</b>
                    ...
                    <p>La relación entre retobilbao.com y el USUARIO se regirá por la normativa española vigente y cualquier controversia se someterá a los Juzgados y tribunales que corresponda.</p>
                </div>
            </div>
        </div>
    </header> 
